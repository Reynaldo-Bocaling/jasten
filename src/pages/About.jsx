...
const About = () => {
  return (
    <section id="about" className="relative w-full">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center px-5 mt-20 md:-mt-20 relative z-30">
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-center">
          {" "}
          <h1 className="text-stroke-lg text-shadow-md font-title text-5xl md:text-7xl text-red-10 z-30 whitespace-nowrap">
            ABOUT JASTEN SAN
          </h1>
      ...
      {/* <img
        ...
        alt=""
      /> */}
      <img src="/img/footer-bg.png" className="w-full -mt-7 md:-mt-16" alt="" />
    </section>
  );
};
